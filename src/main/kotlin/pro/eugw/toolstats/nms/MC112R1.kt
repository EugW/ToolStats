...
class MC112R1(private val itemStackOrigin: org.bukkit.inventory.ItemStack, private val config: FileConfiguration, private val player: Player, private val type: String, private val server: Server) {
